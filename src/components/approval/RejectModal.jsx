    ...
    >
      ...
      >
        <div className="p-5 border-b" style={{ borderColor: 'var(--cu-line)' }}>
          ...
          <p className="text-sm mt-1 truncate" style={{ color: 'var(--cu-muted)' }}>
            {approval.title}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1">
              반려 사유 <span style={{ color: 'var(--cu-danger)' }}>*</span>
            </label>
            <textarea
              value={comment}
              ...
              autoFocus
            />
            <p className="text-xs mt-1 text-right" style={{ color: 'var(--cu-muted)' }}>
              {comment.length} / 500
            </p>
          </div>
